/**
 * Real API client for GECRAI demo.
...
export async function generateMemory({ normativa, voltaje, corriente, proyecto = '', tag = '', resultado = null }) {
    // TODO: replace with real endpoint
    // return request('/memorias', {
    //   method: 'POST',
    //   body: JSON.stringify({ normativa, voltaje, corriente, proyecto, tag, resultado })
    // });
    throw new Error('Backend not connected');
}
